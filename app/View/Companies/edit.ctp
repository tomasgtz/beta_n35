...
<section class="content-header">
    <h1>Empresa<small>Edici&oacute;n de registro</small></h1>    <ol class="breadcrumb">
            ...
            <?php echo $this->Form->input('id',array('class' => 'form-control', 'label' => false)); ?>
                            ...
                            <div class="form-group">
                                <label for="status_id" class="col-sm-2 control-label">Estatus</label>
                                    <div class="col-sm-6 required">
                                        <?php echo $this->Form->input('status_id',array('class' => 'form-control', 'options' => $statuses, 'label' => false)); ?>
                                    </div>
                            </div>                <!-- /.box-body -->
