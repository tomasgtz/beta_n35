...
<head>
  ...
  <?php $this->Html->css("appointment", null, array("inline"=>false)); ?>

  <!-- DayPilot library -->
  <?php $this->Html->js("jquery-1.9.1.min", null, array("inline"=>false)); ?>
  <?php $this->Html->js("daypilot-all.min", null, array("inline"=>false)); ?>
