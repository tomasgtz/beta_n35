    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Nueva Orden desde la cotizacion Folio # <?php echo $this->request->data['Quote']['id']; ?></h3>            </div>
                <!-- /.box-header -->
                <!-- form start -->
		...
		<div class="form-group">
                ...
                <div class="box-footer">
                    <?php echo $this->Html->link('<i class="fa fa-arrow-circle-left"></i>&nbsp;Cancelar', array('controller'=>'Quotes', 'action' => '/index'), array('class' => 'btn btn-danger', 'escape' => false)); ?>
