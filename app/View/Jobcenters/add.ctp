...
<section class="content-header">
    <h1>Centro de trabajo<small>Alta de registro</small></h1>    <ol class="breadcrumb">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">* Favor de llenar todos los campos. Ponga especial atencion en el campo <strong>Numero de empleados</strong>, ya que se usar&aacute; para calcular el numero de evaluaciones </h3>            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <br>
                            ...
                            <div class="form-group">
                                <label for="company_id" class="col-sm-2 control-label">Empresa</label>
                                    <div class="col-sm-6 required">
                                        <?php echo $this->Form->input('company_id',array('class' => 'form-control', 'label' => false, 'readonly' => 'readonly', 'value' => 1)); ?>
                                    </div>
                            </div>
                            <div class="form-group">
