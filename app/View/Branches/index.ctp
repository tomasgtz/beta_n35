                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           echo "
                              ...
                              <b>Fecha de vencimiento</b>: " .date_format(date_create($branch['Branch']['due_date']),"Y-m-d")
                              ;
                           ?>
                        </td>
                        ...
                        <td class="actions" style="text-align:center">
                          ...
                          $this->Html->link(
                            '',
                            array('action'=>'edit',$branch['Branch']['id']),
                            array('class'=>'fa fa-edit fa-lg')
                          ); 
                          ?>
                          &nbsp;&nbsp;
                          <?php 
                          ...
                          $this->Html->link(
                            '',
                            array('controller'=>'BranchesPayments','action'=>'index'),
                            array('class'=>'fa fa-history text-green fa-lg')
                          ); 
                          ?>
                          &nbsp;&nbsp;
                          <?php 
                          ...
                          $this->Html->link(
                            ...
                            array('class'=>'fa fa-laptop text-yellow fa-lg')
                          ); 
                          ?>
                          &nbsp;&nbsp;                          
                          <?php 
